...
def find_candidates_by_ppm_smiles(target_mws, pubchem_mws, ppm_threshold=2):
    """
...
def search_candidates_by_mw(input_data, pubchem_dict, candidates_folder):
    # 解析 CID 和 目标分子量
    target_mws = []
    ...
    result = find_candidates_by_ppm_smiles(target_mws, pubchem_mws, ppm_threshold=2)
...
def filter_candidates_by_formula(input_folder, output_folder):
